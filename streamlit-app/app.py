...
st.markdown(
    ...
    <div style="display:flex; align-items:center; gap:12px;">
        ...
        <span style="font-family:'Space Grotesk',sans-serif; font-size:13px; color:#4b5563;">
            — Prompts em produção</span>
    </div>
    <div style="display:flex; gap:6px;">
        <a href="/" target="_self" style="font-family:'Space Grotesk',sans-serif; font-size:12px; font-weight:600;
            color:#a78bfa; background:rgba(124,58,237,0.15); border:1px solid rgba(124,58,237,0.3);
            padding:6px 14px; border-radius:8px; text-decoration:none;">Catálogo</a>
